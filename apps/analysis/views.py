...
class ManualAnalyzeView(LoginRequiredMixin, View):
    ...
    def _extract_with_direct_ocr(self, file_path):
        """Extract text using direct PDF to image conversion and PaddleOCR."""
        ...
        try:
            ...
            for i, page in enumerate(doc):
                ...
                if raw and raw[0]:
                    ...
                    logger.info(f"   Page {i+1}: No text detected")
            ...
            raise Exception(f"PaddleOCR required for OCR but not available: {e}")
    ...
    def _ocr_image_with_paddle(self, image, ocr):
